...
//Reset the cloth
void MassSpringCuda::ResetCloth()
{
...
void MassSpringCuda::UpdateFrame()
{
...
//Render a frame
void MassSpringCuda::RenderFrame(double currentTime, double timePassed)
{
	//Clear buffers
...
void MassSpringCuda::setfixed(int point, bool isfix)
{
